                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="Dashboard.php" id="topnav-dashboards" role="button" aria-haspopup="true" aria-expanded="false">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button"
                                    ...
                                    <i class="ri-pages-line"></i>Create New <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    <a href="AddAgents.php" class="dropdown-item">Agents</a>
                                    <a href="AddPriceList.php" class="dropdown-item">Price Lists</a>
                                    <a href="AddProducts.php" class="dropdown-item">Products</a>
                                    <a href="AddCustomers.php" class="dropdown-item">Customers</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="ri-briefcase-line"></i>Entry <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-components">
                                    <a href="quotation.php" class="dropdown-item">Quotation</a>
                                    <a href="estimate.php" class="dropdown-item">Estimate</a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layouts" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="ri-layout-line"></i>Report <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                                    <a href="QuotationReport.php" class="dropdown-item">Quotation Report</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layouts" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="ri-layout-line"></i>Miscellaneous <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layouts" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="ri-layout-line"></i>Settings <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                                    <a href="Configuration.php" class="dropdown-item" target="_blank">Configuration</a>
                                    <a href="layouts-light-sidebar.html" class="dropdown-item" target="_blank">Light Sidebar</a>
                                    <a href="layouts-sm-sidebar.html" class="dropdown-item" target="_blank">Small Sidebar</a>
                                    <a href="layouts-collapsed-sidebar.html" class="dropdown-item" target="_blank">Collapsed Sidebar</a>
                                    <a href="layouts-unsticky-layout.html" class="dropdown-item" target="_blank">Unsticky Layout</a>
